...
<head>
    ...
    <title>Building wealth - Nik's Homepage</title>
    <link rel="stylesheet" href="../style.css">
    <script defer data-domain="nkud.me" src="https://plausible.io/js/script.js"></script>
</head>
<body>
    <?php include '../header.php';?>
    <p><a href="../index.php">Home</a> / <a href="index.php">Financial topics</a> / <a href="principles.php">Key prosperity principles</a> / How to build wealth</p>
